...
useEffect(() => {
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fadeIn">
    ...
    {/* ⚡ Modal Box: Handled overflow smoothly across mobile (scrolls entire modal if screen is tiny) and desktop */}
    <div className={`relative w-full max-w-3xl rounded-2xl overflow-hidden shadow-2xl border flex flex-col md:flex-row max-h-[90vh] md:max-h-[85vh] overflow-y-auto md:overflow-visible
    ...
    >
      ...
      {/* 🖼️ Image Section: Fixed aspect ratio bracket and removed broken height properties on mobile */}
      <div className="w-full md:w-2/5 aspect-2/3 md:h-125 overflow-hidden shrink-0">
        <img 
      ...
      {/* 📝 Text Content Section: Flows naturally on mobile, handles secondary internal scroll on desktop */}
      <div className="w-full md:w-3/5 p-6 md:p-8 flex flex-col justify-between h-auto md:h-125 md:overflow-y-auto">
        <div>
          <header className="mb-4 pr-6"> {/* Added padding-right to clear the close 'X' button on mobile */}
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-dashed border-zinc-800/10 dark:border-zinc-700/30 bg-inherit mt-auto">
